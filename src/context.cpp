...
bool Context::Init() {
    ...
    float vertices[] = {
        0.5f, 0.5f, 0.0f, 0.0f, 0.0f, 0.2f, // top right, red
        0.5f, -0.5f, 0.0f, 0.7f, 0.0f, 0.0f, // bottom right, green
       -0.5f, -0.5f, 0.0f, 0.8f, 0.9f, 0.0f, // bottom left, blue
       -0.5f, 0.5f, 0.0f, 0.0f, 0.7f, 0.9f, // top left, yellow
    };
    ...
    glClearColor(0.8f, 0.3f, 0.2f, 0.0f);
